...
export const MEDIX_STYLES = `
  @import url('https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;600;700&display=swap');
  
  @keyframes medix-slideIn {
    from {
...
/**
 * Inject Medix global styles into the document
 */
export function injectStyles(): void {
  if (stylesInjected || document.getElementById("medix-global-styles")) {
    return;
  }

  const styleEl = document.createElement("style");
  styleEl.id = "medix-global-styles";
  styleEl.textContent = MEDIX_STYLES;
