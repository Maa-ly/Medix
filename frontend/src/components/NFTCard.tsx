...
import { MEDIX_PROXY_ADDRESS } from "@/services/contract";
              ...
              <button
                ...
                onClick={(e) => {
                  ...
                  const url = nft.transactionHash
                    ? `https://sepolia-blockscout.lisk.com/tx/${nft.transactionHash}`
                    : `https://sepolia-blockscout.lisk.com/address/${MEDIX_PROXY_ADDRESS}`;
